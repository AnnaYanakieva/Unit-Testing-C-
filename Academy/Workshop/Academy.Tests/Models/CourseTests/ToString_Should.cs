...
namespace Academy.Tests.Models.CourseTests
{
    ...
    {
        [Test]
        public void IterateOverCollection_WhenCollectionIsNotEmpty()
        {
            //Arrange
        ...
        [Test]
        public void IterateOverCollection_WhenCollectionIsNotEmpty_JustMock()
        {
            //Arrange
            var course = new Course("Valid name", 5, new DateTime(2017, 02, 10), new DateTime(2017, 03, 10));
        ...
        [Test]
        public void AddMessageToEndResult_WhenCollectionEmpty()
        {
            //Arrange
            var course = new Course("Valid name", 5, new DateTime(2017, 02, 10), new DateTime(2017, 03, 10));
